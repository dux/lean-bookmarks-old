/* Compiled and copied assets files in use: 
 ...
 - main/widgets/_widgets.coffee
 - main/widgets/bucket_select.coffee
 - main/widgets/markdown.coffee
 - main/widgets/markdown_editor.coffee
...
/* Asset file: main/widgets/_widgets.coffee */
// Generated by CoffeeScript 1.9.3
(function() {
  window.Widgets = {
    auto_id: 0,
    index: {},
    load: function(root_node) {
      root_node || (root_node = document.body);
      return $($('.widget').get().reverse()).each(function() {
        var class_name, el, id, name, widget;
        el = $(this);
        if (el.attr('_init')) {
          return;
        }
        ...
        if (!name) {
          return el.html("<span style='color:#800; font-weight:bold;'>Widget error: No widget NAME</span>");
        }
        ...
        widget.init();
        widget.render();
        return Widgets.index[id] = widget;
      });
    },
    get: function(id) {
      if (!Widgets.index[id]) {
      ...
      return Widgets.index[id].re_root();
    },
    set: function(id, name, value) {
      return Widgets.get(id).set(name, value);
    },
    find: function(el) {
      var id, widget;
      ...
      id = widget.attr('id');
      if (!id) {
        alert("Widget ID not found");
      }
      if (Widgets.index[id]) {
        return Widgets.index[id];
      } else {
        return alert("Widgets.index['" + id + "'] not found");
      }
    }
  };
  ...
  window.Widget = (function() {
    function Widget(root, opts) {
      var el, i, len, node_name, ref;
      this.root = root;
      this.opts = opts;
      this.opts || (this.opts = {});
      ref = this.root[0].attributes;
      for (i = 0, len = ref.length; i < len; i++) {
        el = ref[i];
        if (['class', 'id'].indexOf(el.nodeName) === -1) {
          this.opts[el.nodeName] = el.value;
        }
      }
      node_name = this.root[0].nodeName;
      this.widget = "Widgets.get('" + (this.root.attr('id')) + "')";
      this.id = this.root.attr('id');
      if (!this.root.val()) {
        this.html = $("<" + node_name + ">" + (this.root.html()) + "</" + node_name + ">");
      }
    }
    ...
    Widget.prototype.set = function(name, value) {
      ...
      this.root.attr(name, value);
      return this.render();
    };

    Widget.prototype.re_root = function() {
      this.root = $('#' + this.id).first();
      return this;
    };
...
/* Asset file: main/widgets/bucket_select.coffee */
// Generated by CoffeeScript 1.9.3
(function() {
  var extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;

  window.BucketSelectWidget = (function(superClass) {
    extend(BucketSelectWidget, superClass);

    function BucketSelectWidget() {
      return BucketSelectWidget.__super__.constructor.apply(this, arguments);
    }

    BucketSelectWidget.prototype.init = function() {
      var data, el, i, len, ret, value;
      value = parseInt(this.root.attr('value'));
      data = JSON.parse(this.root.html());
      ret = [];
      ...
      ret.push('</div>');
      return this.root.html(ret.join("\n"));
    };

    return BucketSelectWidget;
...
(function() {
  ...
  window.MarkdownWidget = (function(superClass) {
    ...
    MarkdownWidget.prototype.init = function() {
      return this.root.html(marked(this.root.html()));
    };
...
/* Asset file: main/widgets/markdown_editor.coffee */
// Generated by CoffeeScript 1.9.3
(function() {
  var extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;
  ...
  window.TextAreaEditor = {
    ...
    replaceSelection: function(el, text) {
      var sel, val;
      sel = TextAreaEditor.getInputSelection(el);
      val = el.value;
      el.value = val.slice(0, sel.start) + text + val.slice(sel.end);
    },
    bold: function(ta, tag) {
      var data;
      data = TextAreaEditor.getSelection(ta);
      if (!data.text) {
        return;
      }
      return TextAreaEditor.replaceSelection(ta, "**" + data.text + "**");
    },
    italic: function(ta, tag) {
      var data;
      data = TextAreaEditor.getSelection(ta);
      if (!data.text) {
        return;
      ...
      return TextAreaEditor.replaceSelection(ta, data);
    },
    ul: function(ta, tag) {
      var data;
      data = TextAreaEditor.getSelection(ta);
...
(function() {
  ...
  window.ToggleWidget = (function(superClass) {
    extend(ToggleWidget, superClass);

    function ToggleWidget() {
      return ToggleWidget.__super__.constructor.apply(this, arguments);
    }

    ToggleWidget.prototype.init = function() {
      this.on_state = this.html.find('.on').first().html();
      this.off_state = this.html.find('.off').first().html();
      if (this.opts['button']) {
        this.on_state = "<button class=\"btn btn-default\" onclick=\"" + this.widget + ".toggle()\">" + this.opts['button'] + " &darr;</button>";
        this.off_state = this.html.html();
        if (this.opts['close']) {
    ...
    ToggleWidget.prototype.render = function() {
      if (this.opts['inactive']) {
        this.root.html(this.off_state);
      } else {
        this.root.html(this.on_state);
      }
      return Pjax.on_get();
    };
