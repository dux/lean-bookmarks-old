/* Compiled and copied assets files in use: 
 - admin/js/admin_bootstrap3.min.js
 - admin/js/document_on.js.coffee
 - admin/js/pjax.coffee
 - admin/js/toastr.coffee
 - admin/index.coffee
*/

/* Asset file: admin/js/admin_bootstrap3.min.js */
/*!
...
/* Asset file: admin/js/document_on.js.coffee */
...
(function() {
  this.DocumentOn = {
    ...
    click: function(el) {
      var func, i, len, nn, ref, ret;
      nn = el[0].nodeName;
      if (el.attr('onclick')) {
        return;
      }
      ret = [];
      ref = ['confirm', 'form', 'href'];
          ...
          $.post("/api/" + aa, form.serialize(), function(response) {
            ...
            if (done = form.attr('done')) {
              if (done === 'refresh') {
                ...
                return Pjax.load("/admin/" + response.class_path + "/" + response.data.id);
              } else {
                return eval(done);
              }
            }
...
/* Asset file: admin/js/pjax.coffee */
// Generated by CoffeeScript 1.9.3
(function() {
  this.Pjax = {
    skip_on: [],
...
/* Asset file: admin/js/toastr.coffee */
// Generated by CoffeeScript 1.9.3
(function() {
  this.Info = {
    ok: function(msg) {
